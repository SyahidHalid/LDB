...
df1 = form.file_uploader(label= "Upload Latest Non-Trade - ECL Template:")
if df1:
  T1 = pd.read_excel(df1, sheet_name="Active", header=6)
  #st.write(T1.head(1))
...
if submitted:
  ...
  T1.rename(columns={'Finance (SAP) Number':'Account No'},inplace=True)
  ...
  st.download_button("Download CSV",
                   ...
                   file_name='08. Non Trade - ECL '+str(year)+"-"+str(month)+'.csv',
                   mime='text/csv')